        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="text-[#00F0FF] font-semibold mb-4">{service.price_range}</p>

              <ul className="space-y-3">
                {service.features.map((feature, i) => (
                  <li key={i} className="flex items-start gap-2 text-gray-400 text-sm">
                    <svg className="w-4 h-4 mt-0.5 text-[#00F0FF] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <a
                  ...
                  className="block text-center px-4 py-3 bg-gradient-to-r from-[#00F0FF] to-[#8A2BE2] text-black rounded-lg font-semibold text-sm hover:shadow-lg hover:shadow-cyan-500/25 transition-all duration-300"
                >
                  Pesan Sekarang
                </a>
              </div>

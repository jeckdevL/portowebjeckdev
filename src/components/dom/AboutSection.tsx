        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div {...fadeInUp} className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              pengembangan fullstack dan teknologi 3D web, saya siap membantu mewujudkan
              project Anda dari konsep hingga deployment.
            </p>
            <p className="text-gray-400 leading-relaxed">
              Saya selalu up-to-date dengan teknologi terbaru dan berkomitmen untuk
              memberikan hasil terbaik dengan performa tinggi, SEO optimal, dan user
          ...
          <motion.div {...staggerContainer} className="space-y-6">
            {skills.map((skill) => (
              <motion.div key={skill.name} {...fadeInUp} className="space-y-2">

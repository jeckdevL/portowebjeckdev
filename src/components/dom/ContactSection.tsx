          ...
          <motion.div {...fadeInLeft} className="space-y-8">
            <div>
             ...
             <motion.div className="space-y-4">
               <motion.div 
                 whileHover={{ x: 8 }}
                 className="flex items-center gap-4 p-4 rounded-lg bg-white/5 border border-white/10 hover:border-[#00F0FF]/30 transition-all duration-300"
               >
                 <motion.div 
                   animate={{ boxShadow: ['0 0 0 0 rgba(0,240,255,0.4)', '0 0 0 8px rgba(0,240,255,0)'] }}
                   transition={{ duration: 2, repeat: Infinity }}
                   className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00F0FF]/20 to-[#8A2BE2]/10 flex items-center justify-center flex-shrink-0"
                 >
                 ...
                 <div>
                   ...
                   <a href={`mailto:${PERSONAL_INFO.email}`} className="text-white hover:text-[#00F0FF] transition-colors font-medium">
                     {PERSONAL_INFO.email}
                   </a>
                 </div>
               </motion.div>
